...
.hd { position:sticky; top:0; z-index:20; background:linear-gradient(180deg,rgba(13,18,25,.96),rgba(7,10,14,.9));
      border-bottom:1px solid rgba(60,76,102,.42); box-shadow:0 18px 42px rgba(0,0,0,.28);
      backdrop-filter:blur(18px); }
.hd-row { max-width:1500px; min-height:70px; margin:0 auto; display:flex; align-items:center; gap:10px; padding:12px 22px; }
.brand { display:inline-flex; align-items:center; gap:8px; font-weight:900; font-size:18px; letter-spacing:.2px;
         padding:8px 10px; color:#f4f8ff; text-decoration:none; white-space:nowrap; }
.brand:before { content:"SA"; display:inline-grid; place-items:center; width:28px; height:28px; border-radius:8px;
                color:#07110f; background:linear-gradient(135deg,#1fd6a8,#76f7d6); font-size:10px;
                letter-spacing:.08em; box-shadow:0 0 24px rgba(31,214,168,.26); }
...
.pill-live { display:inline-flex; align-items:center; gap:6px; font-size:11px;
             color:#ff7a86; background:rgba(255,93,108,.08); border:1px solid rgba(255,93,108,.28);
             padding:7px 11px; border-radius:999px; font-weight:800; white-space:nowrap; }
...
.pill-dry { display:inline-flex; align-items:center; gap:6px; font-size:11px;
            color:#e7bf4d; background:rgba(224,179,65,.1); border:1px solid rgba(224,179,65,.28);
            padding:7px 11px; border-radius:999px; font-weight:800; white-space:nowrap; }
.pill-dry .dot { width:6px; height:6px; border-radius:50%; background:#e0b341; animation:lp 1.4s infinite; }
.pill-ai { font-size:11px; color:#b3bfd0; border:1px solid rgba(78,95,125,.5); padding:7px 11px;
           border-radius:999px; background:rgba(10,14,20,.62); white-space:nowrap; }
.pill-bot { font-size:11px; color:#8a95a8; border:1px solid rgba(78,95,125,.5); padding:7px 11px;
            border-radius:999px; background:rgba(10,14,20,.62); white-space:nowrap; }
.pill-bot.on { color:#1fd6a8; border-color:rgba(31,214,168,.36); background:rgba(31,214,168,.1); }
.pill-bot.pause { color:#e0b341; border-color:rgba(224,179,65,.36); background:rgba(224,179,65,.1); }
...
.head-tools { padding:4px; border:1px solid rgba(78,95,125,.42); border-radius:9px; background:rgba(10,14,20,.5); }
.head-tools .mini-btn { border-radius:6px; padding:7px 10px; text-transform:uppercase; letter-spacing:.06em; font-weight:800; }
.section-line { justify-content:space-between; margin:0 0 12px; }
.section-line .section-title { margin:0; }
.inline-tools { flex-wrap:wrap; }
.tabs { display:flex; gap:5px; background:rgba(10,14,20,.58); border:1px solid rgba(78,95,125,.42);
        border-radius:9px; padding:4px; box-shadow:inset 0 1px 0 rgba(255,255,255,.03); }
.tab { font-family:'JetBrains Mono',monospace; font-size:11px; padding:8px 12px; white-space:nowrap;
       border-radius:7px; border:none; cursor:pointer; background:transparent; color:#8a95a8; text-decoration:none;
       text-transform:uppercase; letter-spacing:.07em; transition:background .15s ease,color .15s ease,transform .15s ease; }
.tab:hover { color:#e6ebf2; background:rgba(255,255,255,.04); }
.tab.on { background:linear-gradient(135deg,rgba(31,214,168,.2),rgba(74,148,247,.16)); color:#f4f8ff; font-weight:900;
          box-shadow:0 0 0 1px rgba(31,214,168,.22) inset,0 10px 24px rgba(31,214,168,.08); }
.upd { font-size:11px; color:#69758a; margin-left:6px; white-space:nowrap; }

@media (min-width: 1700px) {
  .tabs { position:fixed; top:88px; left:max(18px,calc((100vw - 1340px)/2 - 174px)); z-index:18;
          width:154px; flex-direction:column; gap:7px; padding:9px; border-radius:10px;
          background:rgba(9,13,19,.78); backdrop-filter:blur(16px);
          box-shadow:0 18px 42px rgba(0,0,0,.34), inset 0 1px 0 rgba(255,255,255,.04); }
  .tabs:before { content:"NAV"; color:#4f5b70; font-size:10px; letter-spacing:.18em; padding:3px 4px 2px; }
  .tab { display:flex; align-items:center; justify-content:space-between; padding:10px 11px; }
  .tab:after { content:""; width:6px; height:6px; border-radius:50%; background:#334055; }
...
.hd-settings-btn { font-family:'JetBrains Mono',monospace; font-size:12px; font-weight:600; line-height:1;
  ...
  border:1px solid rgba(78,95,125,.42); background:rgba(10,14,20,.58); color:#c6cfdd; padding:8px 13px;
  border-radius:9px; cursor:pointer; margin-left:6px; text-decoration:none; text-transform:uppercase; letter-spacing:.06em;
  transition:color .15s ease,border-color .15s ease,background .15s ease,transform .15s ease; }
.hd-settings-btn:hover { color:#fff; border-color:#3a4658; background:#1c2430; transform:translateY(-1px); }
...
#hd-tools { display:inline-flex; align-items:center; gap:6px; }
.hd-clock { font-size:11px; padding:4px 9px; border-radius:4px; border:1px solid #1c2430; white-space:nowrap; }
.hd-clock.open { color:#1fd6a8; border-color:#1c3a32; background:rgba(31,214,168,.08); }
.hd-clock.closed { color:#8a95a8; }
.hd-icon-btn { position:relative; font-size:14px; line-height:1; border:1px solid #1c2430; background:#0a0e14;
  color:#c6cfdd; padding:6px 8px; border-radius:5px; cursor:pointer; }
.hd-icon-btn:hover { border-color:#3a4658; background:#131a24; }
...
(function () {
  ...
  function buildUI() {
    ...
    btn.innerHTML = '<span class="gear">⚙</span><span>Settings</span>';
    ...
    if (!document.getElementById("account-btn")) {
      ...
      acc.innerHTML = '<span>👤</span><span>Login</span>';
...
(function () {
  ...
  function build() {
    ...
    wrap.innerHTML =
      ...
      '<button class="hd-icon-btn" id="hd-calc" title="P&L calculator">🧮</button>' +
      '<span class="hd-bell-wrap"><button class="hd-icon-btn" id="hd-bell" title="Alerts">🔔<span class="hd-badge" id="hd-bell-badge" style="display:none">0</span></button>' +
