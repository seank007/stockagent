...
(function () {
  ...
  function applyTheme(v) { var el = document.documentElement; el.classList.remove("theme-light", "theme-oled"); if (v === "light") el.classList.add("theme-light"); else if (v === "oled") el.classList.add("theme-oled"); }
  ...
  var CATS = [
    { id: "display", label: "테마·표시", items: [
      { pref: "theme", name: "테마", desc: "전체 색 테마", ctrl: "seg", options: [["dark", "다크"], ["light", "라이트"], ["oled", "OLED 블랙"]] },
