...
(() => {{
  ...
  function route(path, params, init) {{
    ...
    if (path === "/api/candles" || path === "/api/stocks/candles") return candles(params.get("ticker") || "KRW-BTC", params.get("interval") || params.get("timeframe") || "minute60", params.get("count") || 120);
